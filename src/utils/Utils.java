...
public class Utils {
    ...
    public static ArrayList<Integer> printListElementsAndCollectChoicesAssignmentsToMark(Scanner sc, ArrayList arraylist) {
        ...
        PrintUtils.printAssignmentsPerStudentPerCourse(arraylist);
        System.out.println("Choose one " + arraylist.get(0).getClass().getSimpleName() + " or more by typing their item number. When done type 'End'. If you want to add all of the students, type 'All'.");
